...
<h2>Производство</h2>
 <p>
 Расчёт стоимости производства продукции в сравнении с ценами на материалы (только первый уровень производства).<br>
 <a class="btn btn-primary" href="/qi_industry_cost.php" role="button">Industry Cost</a>
 </p>

 <p>
 Формулы производства продукции в производственных системах R Industry (все уровни производства).<br>
 <a class="btn btn-danger" href="/qi_conveyor_formulas.php" role="button">Conveyor Formulas</a>
 </p>
