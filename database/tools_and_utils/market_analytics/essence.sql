...
from (
  ...
  from (
    ...
    from (
      ...
      where
        -- 10000050 'Querious', 10000002 'The Forge', 10000015 'Venal', 10000069 'Black Rise', 10000064 'Essence'
        emrh_region_id = 10000064 and
        emrh_date >= '2021-05-17' and emrh_date <= '2021-10-31'
      group by 1, 2
      ) as mh
    group by 1
    ) mha
