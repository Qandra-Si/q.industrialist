...
where
 ...
 ( ebc_blueprint_id is not null and ebc_job_id is null and ebc_blueprint_type_id = 11645 or -- 3489, 3531, 10681, 11250, 11645!
   ebc_job_id is not null and ebc_blueprint_id is null and ebc_job_activity = 8 and ebc_job_product_type_id = 11645
 )
order by 2 desc